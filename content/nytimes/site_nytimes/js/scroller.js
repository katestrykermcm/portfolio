...
/**
* Determines which section user has scrolled to.
*/
function scroller() {
    ...
    /**
    * Constructor function. Sets scroller to monitor scrolling of els selection.
    * @param els - d3 selection of elements that will be scrolled through
    */
    function scroll(els) {
        sections = els;
    ...
    */
    ...
    /**
    * Gets current users position. If user has scrolled to new section, dispatch active event with new section index.
    */
    function position() {
    ...
    /**
    * Get/set the parent element of the sections. Useful if the scrolling doesn't start at the top of the page.
